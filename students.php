    ...
    <body>
        ...
        <main id="main">
            ...
            <section class="content">
                ...
                <img id="mapImage" src="images/campusMap.jpg" alt="Map of the campus" width=75% height="auto">
            </section>
            ...
            <section class="content">
                ...
                <article id="asideText">
                    ...
                    <h5 class="subHeading">Administrative Support</h5>
                    <ul>
                    ...
                    <h5 class="subHeading">Student Services</h5>
                    <ul>
                    ...
                    <h5 class="subHeading">University Services</h5>
                    <ul>
                    ...
                    <h5 class="subHeading">Life at the University</h5>
                    <ul>
                    ...
                    <h5 class="subHeading">Communications</h5>
                    <ul>
